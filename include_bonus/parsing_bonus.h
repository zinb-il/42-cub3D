...
//MAP 2D Images
# define IMG_DOOR "./img_cub/black.xpm"
# define IMG_SPRITE "./img_cub/space.xpm"
...
# define ERROR_DOORS "vous avez mal placé les portes de votre carte"
